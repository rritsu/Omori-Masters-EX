...
void DisplayStrikeSyncGray(Sync sync, char strike[20][150], bool displayInfo, int* max) {
    ...
    char r6[150], r7[150], r8[150];
    if(!sync.isFlinched) {
        sprintf(r6, HI_RED "│" HI_BLACK "        ░▒▒▒░░░              " REG_PURPLE "│" RESET);
        sprintf(r7,  HI_RED "│" HI_BLACK "         ▒░░▒░░░░            " REG_PURPLE "│" RESET);
        sprintf(r8,  HI_RED "│" HI_BLACK "          ░░▒▒░░░▒░          " REG_PURPLE "│" RESET);
    }
    else {
        sprintf(r6, HI_RED "│" HI_PURPLE "═════════════════════════════" REG_PURPLE "│" RESET);
        sprintf(r7, HI_RED "│" BOLD_WHITE "         Flinched: %d         " REG_PURPLE "│" RESET, sync.flinchCounter);
        sprintf(r8, HI_RED "│" HI_PURPLE "═════════════════════════════" REG_PURPLE "│" RESET);
    }
    ...
    *max = 14 + 1;
    ...
    if(displayInfo) {
        char r15[40]  =      "                               ";
        char r16[300];
        DisplayHP(sync.quantity, sync.HP, r16);
...
void DisplayStrikeSync(Sync sync, char strike[20][150], bool displayInfo, int* max) {
    char r0[100] =  REG_RED "╔═════───────  1  ───────═════╗" RESET;
    char r1[100] =  REG_RED "║                             " REG_PURPLE "║" RESET;
    char r2[100] =  REG_RED "║" HI_RED "     ▒▒░                     " REG_PURPLE "║" RESET;
    char r3[100] =  REG_RED "│" HI_RED "      ░░▒▒░                  " REG_PURPLE "│" RESET;
    char r4[100] =  REG_RED "│" HI_RED "      ░▓▒▒▒░                 " REG_PURPLE "│" RESET;
    char r5[100] =  REG_RED "│" HI_RED "       ░░▒▒░▒░               " REG_PURPLE "│" RESET;
    char r6[150], r7[150], r8[150];
    if(!sync.isFlinched) {
        sprintf(r6, REG_RED "│" HI_RED "        ░▒▒▒░░░              " REG_PURPLE "│" RESET);
        sprintf(r7,  REG_RED "│" HI_RED "         ▒░░▒░░░░            " REG_PURPLE "│" RESET);
        sprintf(r8,  REG_RED "│" HI_RED "          ░░▒▒░░░▒░          " REG_PURPLE "│" RESET);
    }
    else {
        sprintf(r6, REG_RED "│" HI_PURPLE "═════════════════════════════" REG_PURPLE "│" RESET);
        sprintf(r7, REG_RED "│" BOLD_WHITE "         Flinched: %d         " REG_PURPLE "│" RESET, sync.flinchCounter);
        sprintf(r8, REG_RED "│" HI_PURPLE "═════════════════════════════" REG_PURPLE "│" RESET);
    }
    char r9[100] =  REG_RED "│" HI_RED "          ░▒▒░▒░░▓█▓░        " REG_PURPLE "│" RESET;
    char r10[100] = REG_RED "│" HI_RED "            ░▓░▒▒  ▓▒▒       " REG_PURPLE "│" RESET;
    char r11[100] = REG_RED "│" HI_RED "             ░░     ░▓█▒     " REG_PURPLE "│" RESET;
    char r12[100] = REG_RED "║" HI_RED "                      ░░     " REG_PURPLE "║" RESET;
    char r13[100] = REG_RED "║" HI_RED "                             " REG_PURPLE "║" RESET;
    char r14[150] = REG_PURPLE "╚═════────── " HI_RED "STRIKE" REG_PURPLE " ─────═════╝" RESET;
...
void DisplayTechSync(Sync sync, char tech[20][150], bool displayInfo) {
    char r0[100] =  REG_BLUE "╔═════───────  2  ───────═════╗" RESET;
    char r1[100] =  REG_BLUE "║                             " REG_PURPLE "║" RESET;
    char r2[100] =  REG_BLUE "║" HI_BLUE "         ▒▓██▓▓▓▓░           " REG_PURPLE "║" RESET;
    char r3[100] =  REG_BLUE "│" HI_BLUE "       ░▓▒▓▓▓▒▒█▒▒▒          " REG_PURPLE "│" RESET;
    char r4[100] =  REG_BLUE "│" HI_BLUE "       ░█▒░▓░█▓▒▓▒▓▓         " REG_PURPLE "│" RESET;
    char r5[100] =  REG_BLUE "│" HI_BLUE "       ░█░░░▓▒▓▓█▓▒▒▓░       " REG_PURPLE "│" RESET;
    char r6[150], r7[150], r8[150];
    if(!sync.isFlinched) {
        sprintf(r6, REG_BLUE "│" HI_BLUE "        ▓▒░░▓▒░█▓▒░▒▒        " REG_PURPLE "│" RESET);
        sprintf(r7, REG_BLUE "│" HI_BLUE "         ▒▓▓▒░▒▓░▒▓▒░        " REG_PURPLE "│" RESET);
        sprintf(r8, REG_BLUE "│" HI_BLUE "            ▒▓░░▓░▒▒         " REG_PURPLE "│" RESET);
    }
    else {
        sprintf(r6, REG_BLUE "│" HI_PURPLE "═════════════════════════════" REG_PURPLE "│" RESET);
        sprintf(r7, REG_BLUE "│" BOLD_WHITE "         Flinched: %d         " REG_PURPLE "│" RESET, sync.flinchCounter);
        sprintf(r8, REG_BLUE "│" HI_PURPLE "═════════════════════════════" REG_PURPLE "│" RESET);
    }
    char r9[100] =  REG_BLUE "│" HI_BLUE "                ░█░▒▓░       " REG_PURPLE "│" RESET;
    char r10[100] = REG_BLUE "│" HI_BLUE "                 ░▓░░▒       " REG_PURPLE "│" RESET;
    char r11[100] = REG_BLUE "│" HI_BLUE "                  ▒▒░▒▓      " REG_PURPLE "│" RESET;
    char r12[100] = REG_BLUE "║" HI_BLUE "                   ▓▓▒       " REG_PURPLE "║" RESET;
    char r13[100] = REG_BLUE "║" HI_BLUE "                             " REG_PURPLE "║" RESET;
...
void DisplayTechSyncGray(Sync sync, char tech[20][150], bool displayInfo) {
    ...
    char r6[150], r7[150], r8[150];
    if(!sync.isFlinched) {
        sprintf(r6, HI_BLUE "│" HI_BLACK "        ▓▒░░▓▒░█▓▒░▒▒        " REG_PURPLE "│" RESET);
        sprintf(r7, HI_BLUE "│" HI_BLACK "         ▒▓▓▒░▒▓░▒▓▒░        " REG_PURPLE "│" RESET);
        sprintf(r8, HI_BLUE "│" HI_BLACK "            ▒▓░░▓░▒▒         " REG_PURPLE "│" RESET);
    }
    else {
        sprintf(r6, HI_BLUE "│" HI_PURPLE "═════════════════════════════" REG_PURPLE "│" RESET);
        sprintf(r7, HI_BLUE "│" BOLD_WHITE "         Flinched: %d         " REG_PURPLE "│" RESET, sync.flinchCounter);
        sprintf(r8, HI_BLUE "│" HI_PURPLE "═════════════════════════════" REG_PURPLE "│" RESET);
    }
...
void DisplaySupportSync(Sync sync, char support[20][150], bool displayInfo) {
    char r0[100] =  HI_YELLOW "╔═════───────  3  ───────═════╗" RESET;
    char r1[100] =  HI_YELLOW "║                             " REG_PURPLE "║" RESET ;
    char r2[100] =  HI_YELLOW "║" REG_YELLOW "               ░▓▒           " REG_PURPLE "║" RESET;
    char r3[100] =  HI_YELLOW "│" REG_YELLOW "       ░▒▒░░▓▒░░▓▒           " REG_PURPLE "│" RESET;
    char r4[100] =  HI_YELLOW "│" REG_YELLOW "      █░░▒▒░▒▓▓██▒           " REG_PURPLE "│" RESET;
    char r5[100] =  HI_YELLOW "│" REG_YELLOW "    ░▒▓░▓▓▒▓▓▓▒▒▓▓░▒▒░       " REG_PURPLE "│" RESET;
    char r6[150], r7[150], r8[150];
    if(!sync.isFlinched) {
        sprintf(r6, HI_YELLOW "│" REG_YELLOW "         ░▒▓▒▒░▓▒▓▒░░░▓▒     " REG_PURPLE "│" RESET);
        sprintf(r7, HI_YELLOW "│" REG_YELLOW "        ░▓▒▒▒░░░░░░░░░░▒▒    " REG_PURPLE "│" RESET);
        sprintf(r8, HI_YELLOW "│" REG_YELLOW "        ▒▓▒▒▒░░░░░░░░░░░▓    " REG_PURPLE "│" RESET);
    }
    else {
        sprintf(r6, HI_YELLOW "│" HI_PURPLE "═════════════════════════════" REG_PURPLE "│" RESET);
        sprintf(r7, HI_YELLOW "│" BOLD_WHITE "         Flinched: %d         " REG_PURPLE "│" RESET, sync.flinchCounter);
        sprintf(r8, HI_YELLOW "│" HI_PURPLE "═════════════════════════════" REG_PURPLE "│" RESET);
    }
    char r9[100] =  HI_YELLOW "│" REG_YELLOW "       ░▓▒▒░░░░░░░░░░░░░▒    " REG_PURPLE "│" RESET;
    char r10[100] = HI_YELLOW "│" REG_YELLOW "       ░▓▒▒░░░░░░░░░░░░▓░    " REG_PURPLE "│" RESET;
    char r11[100] = HI_YELLOW "│" REG_YELLOW "          ░▒▒▒░░░░░░░░░▓░    " REG_PURPLE "│" RESET;
    char r12[100] = HI_YELLOW "║" REG_YELLOW "          ░▒▓▓▒▒▒▓▓▓▒░       " REG_PURPLE "║" RESET;
    char r13[100] = HI_YELLOW "║" REG_YELLOW "                             " REG_PURPLE "║" RESET;
...
void DisplaySupportSyncGray(Sync sync, char support[20][150], bool displayInfo) {
    ...
    char r6[150], r7[150], r8[150];
    if(!sync.isFlinched) {
        sprintf(r6, REG_YELLOW "│" HI_BLACK "         ░▒▓▒▒░▓▒▓▒░░░▓▒     " REG_PURPLE "│" RESET);
        sprintf(r7, REG_YELLOW "│" HI_BLACK "        ░▓▒▒▒░░░░░░░░░░▒▒    " REG_PURPLE "│" RESET);
        sprintf(r8, REG_YELLOW "│" HI_BLACK "        ▒▓▒▒▒░░░░░░░░░░░▓    " REG_PURPLE "│" RESET);
    }
    else {
        sprintf(r6, REG_YELLOW "│" HI_PURPLE "═════════════════════════════" REG_PURPLE "│" RESET);
        sprintf(r7, REG_YELLOW "│" BOLD_WHITE "         Flinched: %d         " REG_PURPLE "│" RESET, sync.flinchCounter);
        sprintf(r8, REG_YELLOW "│" HI_PURPLE "═════════════════════════════" REG_PURPLE "│" RESET);
    }
